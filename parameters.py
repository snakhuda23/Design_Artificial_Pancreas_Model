...
class PatientParameters:
    ...
    k_PL = 0.008 #Rate of insulin transfer from Liver to Plasma
    k_LP = 0.322 #Rate of insulin transfer from Plasma to Liver

    k_0P = 0.119 #Rate of insulin clearance from Plasma
    k_0L = 0.008 #Rate of insulin clearance from Liver
